...
{
    public partial class DaiDoi_DaXacNhan : UserControl
    {
        MyDBContext db = new MyDBContext();

        public DaiDoi_DaXacNhan()
        {
            InitializeComponent();
        ...
        {
            DaiDoi_DaXacNhan_Load(this, new EventArgs());
        }

        private void DaiDoi_DaXacNhan_Load(object sender, EventArgs e)
        {
